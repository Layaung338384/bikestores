...
<body>
    <div class="container-fluid p-0 m-0">
        ...
        <div class="toto d-flex justify-content-center mt-5 p-3 bg-secondary">
            <div class="brand">
                <a href="staff_create.php" class="btn btn-success ms-3" >Staff Create</a>
            </div>   
            <div class="categories">
                <a href="staff_login.php" class="btn btn-success ms-3">Staff Login</a>
            </div>
        </div>
